<template>
	<div>
		<b-form-group v-if="$check_register_field('add','id','/user_registration/view')" id="input-group-0" label="身份证" label-for="input-0">
			<b-form-input id="input-0" v-model="form['id']" type="text" placeholder="身份证" trim></b-form-input>
		</b-form-group>
	</div>
</template>
